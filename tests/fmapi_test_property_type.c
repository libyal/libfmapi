...
#include "../libfmapi/libfmapi_property_type.h"
...
#endif
{
	...
	/* TODO: add tests for libfmapi_property_type_get_identifier */

	/* TODO: add tests for libfmapi_property_type_get_description */
