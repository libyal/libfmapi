...
#include "fmapi_test_libcstring.h"
#include "fmapi_test_libfmapi.h"
#include "fmapi_test_macros.h"
#include "fmapi_test_unused.h"

/* Tests the libfmapi_get_version function
 * Returns 1 if successful or 0 if not
 */
int fmapi_test_get_version(
     void )
{
	const char *version_string = NULL;
	int result                 = 0;

	version_string = libfmapi_get_version();
