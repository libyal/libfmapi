...
#if !defined( _LIBFMAPI_TYPES_H )
#define _LIBFMAPI_TYPES_H
...
#define __USE_UNIX98
#define LIBFMAPI_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBFMAPI_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBFMAPI_DEFINITION_UNIX98
#endif
